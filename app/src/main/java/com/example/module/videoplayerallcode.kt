...
//            Toast.makeText(this@VideoPlaybackActivity,"No videos available",Toast.LENGTH_SHORT).show()
...
//            Companion.showCustomToast(this, "No next video", R.drawable.railway, Gravity.BOTTOM, 0, 200)
//        }
//
...
//            Companion.showCustomToast(this, "No previous video",
...
//
//    companion object {
//        fun showCustomToast(context: Context, text: String, imageResource: Int, gravity: Int, xOffset: Int, yOffset: Int) {
...
//////            showMessage("No previous video available")
//////            Toast.makeText(this@VideoPlaybackActivity,"No previous video",Toast.LENGTH_SHORT).show()
////            showCustomToast(this, "No previous video",
////                R.drawable.railway, Gravity.BOTTOM, 0, 200)
////        }
////    }
////
...
////            })
////        }
//////        val playPauseButton = findViewById<ToggleButton>(R.id.playPauseButton)
//////        playPauseButton.setOnCheckedChangeListener { _, isChecked ->
//////            if (isChecked) {
//////                videoView.start() // Play video when button is checked (Play)
//////            } else {
//////                videoView.pause() // Pause video when button is not checked (Pause)
//////            }
//////        }
////
////    }
...
////    }
////
////// Inside your VideoPlaybackActivity class
////
...
////            // Landscape mode
////            layoutParams.width = resources.getDimensionPixelSize(R.dimen.landscape_seekbar_width)
////        } else {
////            // Portrait mode
////            layoutParams.width = resources.getDimensionPixelSize(R.dimen.portrait_seekbar_width)
////        }
...
////        val videoUrl = intent.getStringExtra("videoUrl")
////
//////        // Attach media controller for play/pause functionality
...
////        requestedOrientation = ActivityInfo.SCREEN_ORIENTATION_PORTRAIT
////        // Restore the system UI visibility when exiting the video playback
////        window.decorView.systemUiVisibility = View.SYSTEM_UI_FLAG_VISIBLE
////    }
////
////}
